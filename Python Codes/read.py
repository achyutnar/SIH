...
def DetectGesture(pitchDiff1,pitchDiff2,pitchDiff3,yawDiff1,yawDiff2,yawDiff3,rollDiff1,rollDiff2,rollDiff3):
    ...
    if(pitchDiff2 <= (-1*valChange1_5) and pitchDiff3 <=(-1*valChange1_5)):
        move_right(max(-1*pitchDiff1,-1*pitchDiff2,-1*pitchDiff3))
        print("move_left")
    # elif(pitchDiff1 >= 0.3 and pitchDiff3 >= valChange1_5 and yawDiff1 < valChange1_5 and rollDiff1 < valChange1_5 and yawDiff2 < valChange1_5 and rollDiff2 < valChange1_5):
    #     print("zoom_in")
    #     zoom_in(max(pitchDiff1,-1*pitchDiff2))
    # elif(pitchDiff3 <= -1 and pitchDiff1 <= -0.5 and yawDiff1 < valChange1_5 and rollDiff1 < valChange1_5 and yawDiff2 < valChange1_5 and rollDiff2 < valChange1_5):
    #     print("zoom_out")
    #     zoom_out(max(-1*pitchDiff1,pitchDiff2))
        ...
        print("scroll up")
    elif(pitchDiff2 >=valChange1_5 and pitchDiff3 >=valChange1_5):
